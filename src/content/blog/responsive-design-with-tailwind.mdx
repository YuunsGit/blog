...
pubDate: 'Aug 06 2023'
heroImage: '/blog/responsive-design-with-tailwind.jpg'
---
...
![image](/images/responsive-deisgn-ughh.jpg)
...
<div className="relative flex items-center justify-center h-96 border-2 rounded-lg resize-x overflow-auto w-full max-w-full min-w-[302px] bg-[url('/images/dot-pattern.svg')] bg-repeatbg-[length:50px]">
    <iframe src="/examples/responsive.html" className="h-full w-full my-auto"/>
    <p className="absolute -bottom-3 right-2 font-bold text-base px-2 py-1 border-2 rounded bg-white">Resize here &#8600;</p>
</div>
...
- Image height is 40 by default (`sm:h-40`)

```html
<div class="flex flex-col sm:flex-row items-center gap-8 border-2 rounded-lg p-4 bg-white shadow-xl">
    <img src="/images/lake.png" class="h-28 sm:h-40 rounded-lg" alt="Lake" />
    <p>
